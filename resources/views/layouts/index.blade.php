...
<head>
    <title>@yield('title') | AL-Mani Foods Products</title>
    <meta name="description" content="AL-Mani Foods Products produce and deliver premium offerings, including cookies, rusk toast, cup cakes, puffed rice, snacks, semai, noodles, drinks, chips, spices, and culinary products. Developed by A. H. M. Azimul Haque.">
    <meta name="keywords" content="AL-Mani Foods Products">
    <meta charset="utf-8">
        ...
        <div class="container footer-middle">
            <div class="row">
                <div class="col-md-3 col-sm-3 footer-link1 xs-display-none">
                    ...
                    <!-- end headline -->
                    <!-- text -->
                    <p class="footer-text">Start your journey with <b>AL-Mani Foods Products</b> and we will keep providing you with the best products available, in shaa Allah!</p>
                    <!-- end text -->
                </div>
