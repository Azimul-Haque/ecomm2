    ...
    <div class="col-md-2">
      <div class="row">
        <div class="btn-group-vertical col-md-12" role="group" aria-label="...">
          ...
          <a href="{{ route('warehouse.deliveredorders') }}" class="btn btn-default btn-block"><i class="fa fa-list-ul" aria-hidden="true"></i> ডেলিভার্ড Orders <span class="label label label-primary">{{ $completed_orders }}</span></a>
